...
RUN pip install numpy pandas scipy scikit-learn pysftp seaborn
...
RUN R -e "install.packages(c('devtools', 'git2r', 'packrat', 'Rcpp', 'shiny', 'shinydashboard', 'rmarkdown', 'leaflet', 'readr', 'DT', 'dplyr', 'openxlsx'))"
