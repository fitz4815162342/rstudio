...
RUN R -e "install.packages(c('gbm', 'data.table', 'mltools', 'dict', 'shiny', 'rmarkdown', 'plotly', 'rhandsontable', 'caret', 'e1071', 'randomForest', 'dplyr'), repos='https://cloud.r-project.org/')"
